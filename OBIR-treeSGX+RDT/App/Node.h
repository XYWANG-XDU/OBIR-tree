...
public:
    ...
    sgx_status_t s=SGX_SUCCESS;

    void addVirtualBranch(map<int,string> text_position_map,int temp_ID,string Com);

//    virtual void addVirtualBranch(map<int,string> text_position_map,int temp_ID,string Com);
